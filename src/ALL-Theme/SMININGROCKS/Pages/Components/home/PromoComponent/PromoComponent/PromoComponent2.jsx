...
var BrandsContent = [
    {
        "image": storImagePath() + "/images/HomePage/Brands/BrandImg01.jpg",
        "title": "Beyond Basic ",
    ...
    {
        "image": storImagePath() + "/images/HomePage/Brands/BrandImg06.jpg",
        "title": "Storyst",
    ...
    {
        "image": storImagePath() + "/images/HomePage/Brands/BrandImg04.jpg",
        "title": "Nuera",
    ...
    {
        "image": storImagePath() + "/images/HomePage/Brands/BrandImg05.jpg",
        "title": "Promise",
    ...
    {
        "image": storImagePath() + "/images/HomePage/Brands/BrandImg02.jpg",
        "title": "Diament",
    ...
    {
        "image": storImagePath() + "/images/HomePage/Brands/BrandImg03.jpg",
        "title": "Lovent",
                    ...
                    <SwiperSlide key={index}>
                        <div className='promo-daimondBoxMain'>
                            ...
                            <div className='promo-daimondBox2'>
                                <img src={item.image} className='promo-daimondBox2-image' alt={`Item ${index + 1}`} />
                            </div>
                        </div>
                    </SwiperSlide>
                ))}
