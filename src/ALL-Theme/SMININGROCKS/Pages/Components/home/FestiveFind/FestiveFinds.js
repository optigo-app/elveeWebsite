            ...
            <div className='gorGiftMain'>
                <div className='gorGiftBox1'>
                    <div>
                        ...
                        <img src={`${storImagePath()}/images/HomePage/Promo/Set/1/promoSetBanner1Img1.jpg`} className='gorGiftBox1Images' />
                    </div>
                    <div className='gorGiftBox1Sub1'>
                        <p className='gorGiftBoxMainTitleWeb'>KIDS</p>
                        <img src={`${storImagePath()}/images/HomePage/Promo/Set/1/promoSetBanner1Img3.jpg`} className='gorGiftBox1Images' />
                    </div>
                </div>
                <div className='gorGiftBox1'>
                    <div>
                        <p className='gorGiftBoxMainTitleWeb'>MEN</p>
                        <img src={`${storImagePath()}/images/HomePage/Promo/Set/1/promoSetBanner1Img2.jpg`} className='gorGiftBox1Images' />
                    </div>
                    <div className='gorGiftBox2Sub1' >
                        <p className='gorGiftBoxMainTitleWeb'>GIFTS</p>
                        <img src={`${storImagePath()}/images/HomePage/Promo/Set/1/promoSetBanner1Img4.jpg`} className='gorGiftBox1Images' />
                    </div>
                </div>
            </div>
